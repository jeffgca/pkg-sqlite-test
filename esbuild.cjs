// from: https://github.com/zwave-js/zwave-js-ui/blob/master/esbuild.js
// ...probably some extraneous stuff in there.
...
const outputScript = CONFIG.outputScript || 'main.cjs'
...
async function main() {
	...
	const outfile = `${outputDir}/${outputScript}`
	...
	pkgJson.scripts = {
		start: `node ${outputScript}`,
	}

	pkgJson.bin = outputScript
	pkgJson.pkg = {
